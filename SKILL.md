...
- Initial supported metrics remain CRP, ESR, HGB, PLT, infliximab concentration, and infliximab antibody. Add a metric definition only when the user explicitly adopts it.
